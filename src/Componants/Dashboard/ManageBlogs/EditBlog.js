...
export default function BasicModal({ open, setOpen, editBlog, handleDelete }) {
    const { register, handleSubmit } = useForm();
    const { rating, location, blogTitle, blogPoster, bloggerEmail, cost, description, status, _id } = editBlog
                ...
                <Box sx={style}>
                    ...
                    >
                        ...
                        <Stack direction="row" spacing={2}>
                            {!status && <Button size="small" variant="contained" color='success' onClick={() => handleApprove(_id)}>
                                Approve
                            </Button>}
